...
-- Created: 22:27 ope, Sunday 05 August, 2012
-- Command line: -fno-qualified-names -fno-imports -fno-export-lists -fout-pointers-are-not-refs -c agentsvr.IDL -o agentsvr.hs

module Agentsvr where
